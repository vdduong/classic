...
class GeneticFunctions(object):
  ...
  def check_stop(self, fits_populations):
    r'''stop run if returns True- fits_populations: list of (fitness_value, chromosome)'''
    return False
...
if __name__ == '__main__':
  ...
  class GuessText(GeneticFunctions):
    ...
    # geneticFunctions interface impl
    def probability_crossover(self):
    ...
    def check_stop(self, fits_populations):
      ...
      if self.counter % 10 == 0:
        ...
        print('[G %3d] score=(%4d, %4d, %4d): %r'%(self.counter, best, ave, worst, self.chromo2text(best_match)))
        pass
    ...
    def crossover(self, parents):
      ...
      child2 = father[:index1] + father[index1:index2] + mother[index2:]
